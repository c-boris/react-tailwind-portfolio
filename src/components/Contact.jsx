  ...
  return (
    <div name='contact' className='w-full h-fit bg-[#0a192f] flex justify-center items-center p-4 pt-24 sm:h-screen'>
        ...
        <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white rounded-md border-2 hover:bg-blue-600 hover:border-blue-600 px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
